...
export default function Offers() {
  ...
  const handleBuy = async (productId: string) => {
    ...
    if (productId === "cameleon") navigate("/checkout?productId=cameleon");
    else if (productId === "psychology") navigate("/checkout?productId=psychology");
    ...
    else if (productId === "full_pack") navigate("/checkout?productId=cameleon");
