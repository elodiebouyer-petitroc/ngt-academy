            ...
            <div className="lg:col-span-2">
              <div className="relative">
                {formation?.downloadUrl ? (
                  <div className="w-full aspect-video bg-ngt-dark-gray border border-ngt-gold/20 rounded-xl flex flex-col items-center justify-center p-12 text-center group">
                    <div className="w-24 h-24 bg-ngt-gold/10 rounded-full flex items-center justify-center text-ngt-gold mb-8 group-hover:scale-110 transition-transform duration-500">
                      <FileArchive size={48} />
                    </div>
                    <h3 className="text-3xl font-serif italic gold-text mb-4">Votre Algorithme est prêt</h3>
                    <p className="text-gray-400 mb-8 max-w-md">
                      Cliquez sur le bouton ci-dessous pour télécharger le fichier d'installation de l'Algorithme Caméléon.
                    </p>
                    <a 
                      href={formation.downloadUrl}
                      className="px-10 py-4 bg-ngt-gold text-ngt-black font-bold uppercase tracking-[0.2em] rounded-xl gold-gradient flex items-center gap-3 hover:scale-[1.05] transition-all shadow-xl shadow-ngt-gold/10"
                    >
                      <Download size={20} /> Télécharger l'Algorithme
                    </a>
                    <p className="mt-6 text-[10px] text-gray-600 uppercase tracking-widest flex items-center gap-2">
                       <ShieldCheck size={12} /> Fichier vérifié et sécurisé
                    </p>
                  </div>
                ) : (
                  <>
