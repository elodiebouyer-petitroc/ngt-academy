...
import { Menu, X, Youtube, LogOut } from "lucide-react";
...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "Test Psychologie", href: "/test-psychologie" },
          ...
          <div className="flex items-center gap-6 border-l border-ngt-white/10 pl-10">
            ...
            {user && (
              <button 
                ...
                className="text-ngt-white/40 hover:text-ngt-red transition-colors"
                title="Déconnexion"
              >
                <LogOut size={18} />
              </button>
        ...
        >
          ...
          <div className="pt-4 border-t border-ngt-white/10 flex flex-col gap-6">
            ...
            {user && (
              <button 
                onClick={handleLogout}
                className="flex items-center gap-3 text-sm uppercase tracking-widest text-ngt-red hover:text-red-500 transition-colors"
              >
                <LogOut size={20} />
                Déconnexion
              </button>
