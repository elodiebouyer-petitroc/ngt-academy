...
export default function Products() {
  ...
  const handleBuy = async (productId: string) => {
    ...
    if (productId === "psychology") navigate("/checkout?productId=psychology");
    else if (productId === "cameleon") navigate("/checkout?productId=cameleon");
  ...
  const products = [
    ...
    },
    {
      ...
      link: "/checkout?productId=cameleon",
      highlight: true,
